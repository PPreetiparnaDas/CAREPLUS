            ...
            <div class="row align-items-center mb-n6">
                ...
                <div class="col-lg-5 mb-6">
                    ...
                    <div class="about-thumb" data-aos="fade-up" data-aos-delay="200">
                        <img class="fit-image" src="assets/images/blog/blog-medium/5.jpg" height=500px width=300px alt="About Image">
                    </div>
                    <!-- About Thumb End -->
            ...
            <div class="row">
                ...
                <div class="col-12" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p class="sub-title">Accumsan vitae pede lacus ut ullamco</p>
                    </div>
                    <!-- Section Title End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <div class="team-thumb">
                            ...
                            <img class="fit-image" src="assets/images/blog/blog-medium/2.png" alt="Team Image">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <div class="team-thumb">
                            ...
                            <!-- Team Member Image Start -->
                            <img class="fit-image" src="assets/images/blog/blog-medium/1.png" alt="Team Image">
                            <!-- Team Member Image End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <div class="team-thumb">
                            ...
                            <!-- Team Member Image Start -->
                            <img class="fit-image" src="assets/images/blog/blog-medium/3.png" alt="Team Image">
                            <!-- Team Member Image End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <div class="team-thumb">
                            ...
                            <!-- Team Member Image Start -->
                            <img class="fit-image" src="assets/images/blog/blog-medium/4.png" alt="Team Image">
                            <!-- Team Member Image End -->
